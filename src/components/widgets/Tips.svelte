<script context="module" lang="ts">
	const tips = [
		"You can change the gamemode by clicking JOSERDLE or swiping the board left or right.",
		...
		"Everyone has the same JOSERDLE at the same time. Your word #73 is the same as everyone elses #73.",
